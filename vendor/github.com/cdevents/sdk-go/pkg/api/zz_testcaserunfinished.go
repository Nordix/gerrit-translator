...
type TestCaseRunFinishedSubjectContent struct {
	...
	Outcome string `json:"outcome" cdevents:"outcome"`

	Reason string `json:"reason,omitempty" cdevents:"reason"`

	Severity string `json:"severity,omitempty" cdevents:"severity"`

	TestCase *TestCaseRunFinishedSubjectContentTestCase `json:"testCase,omitempty" cdevents:"testCase"`

	TestSuiteRun *Reference `json:"testSuiteRun,omitempty" cdevents:"testSuiteRun"`
}
