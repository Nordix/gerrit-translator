...
type TestCaseRunQueuedSubjectContent struct {
	...
	TestCase *TestCaseRunQueuedSubjectContentTestCase `json:"testCase,omitempty" cdevents:"testCase"`

	TestSuiteRun *Reference `json:"testSuiteRun,omitempty" cdevents:"testSuiteRun"`

	Trigger *TestCaseRunQueuedSubjectContentTrigger `json:"trigger,omitempty" cdevents:"trigger"`
}
