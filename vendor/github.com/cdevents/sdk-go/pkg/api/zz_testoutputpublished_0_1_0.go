...
type TestOutputPublishedSubjectContent struct {
	Format string `json:"format" cdevents:"format"`

	OutputType string `json:"outputType" cdevents:"outputType"`

	TestCaseRun *Reference `json:"testCaseRun,omitempty" cdevents:"testCaseRun"`
