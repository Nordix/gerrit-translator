...
type ServiceDeployedSubjectContent struct {
	ArtifactId string `json:"artifactId" validate:"purl" cdevents:"artifactId"`
...
func (e ServiceDeployedEventV0_1_1) GetType() CDEventType {
	return ServiceDeployedEventTypeV0_1_1
}
...
func (e ServiceDeployedEventV0_1_1) GetId() string {
	return e.Context.Id
}
