...
type TestCaseRunStartedSubjectContent struct {
	...
	TestCase *TestCaseRunStartedSubjectContentTestCase `json:"testCase,omitempty" cdevents:"testCase"`

	TestSuiteRun *Reference `json:"testSuiteRun,omitempty" cdevents:"testSuiteRun"`

	Trigger *TestCaseRunStartedSubjectContentTrigger `json:"trigger,omitempty" cdevents:"trigger"`
}
