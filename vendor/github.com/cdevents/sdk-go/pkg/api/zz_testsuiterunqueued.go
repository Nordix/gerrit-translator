...
type TestSuiteRunQueuedSubjectContent struct {
	...
	TestSuite *TestSuiteRunQueuedSubjectContentTestSuite `json:"testSuite,omitempty" cdevents:"testSuite"`

	Trigger *TestSuiteRunQueuedSubjectContentTrigger `json:"trigger,omitempty" cdevents:"trigger"`
}
...
type TestSuiteRunQueuedSubjectContentTestSuite struct {
	...
	Url string `json:"url,omitempty" cdevents:"url"`
