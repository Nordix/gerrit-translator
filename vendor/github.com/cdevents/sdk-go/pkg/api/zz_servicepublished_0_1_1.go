...
type ServicePublishedSubjectContent struct {
	Environment *Reference `json:"environment,omitempty" cdevents:"environment"`
}
...
func (e ServicePublishedEventV0_1_1) GetType() CDEventType {
	return ServicePublishedEventTypeV0_1_1
}
...
func (e ServicePublishedEventV0_1_1) GetId() string {
	return e.Context.Id
}
