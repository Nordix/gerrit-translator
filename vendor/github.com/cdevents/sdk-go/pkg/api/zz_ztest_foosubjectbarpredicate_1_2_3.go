...
type FooSubjectBarPredicateSubjectContent struct {
	...
	ObjectField *FooSubjectBarPredicateSubjectContentObjectField `json:"objectField,omitempty" cdevents:"objectField"`

	PlainField string `json:"plainField" cdevents:"plainField"`

	ReferenceField *Reference `json:"referenceField" cdevents:"referenceField"`
}
