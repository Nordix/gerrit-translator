...
func (e EnvironmentCreatedEventV0_1_1) GetType() CDEventType {
	return EnvironmentCreatedEventTypeV0_1_1
}
...
func (e EnvironmentCreatedEventV0_1_1) GetId() string {
	return e.Context.Id
}
...
func (e *EnvironmentCreatedEventV0_1_1) SetId(id string) {
	e.Context.Id = id
}
