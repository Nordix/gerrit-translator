...
type TaskRunFinishedSubjectContent struct {
	Errors string `json:"errors,omitempty" cdevents:"errors"`

	Outcome string `json:"outcome,omitempty" cdevents:"outcome"`

	PipelineRun *Reference `json:"pipelineRun,omitempty" cdevents:"pipelineRun"`

	TaskName string `json:"taskName,omitempty" cdevents:"taskName"`
